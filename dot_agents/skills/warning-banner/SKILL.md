...
For all styling, use standard terminal syntax and colors so it displays correctly in apps like Terminal.app and other standard OS terminals.
...
3. Lines 3...X: A short but precise summary of the issue (assuming there is additional details earlier in your response). Finish with mitigation suggestions if applicable. All yellow text. If text gets too long, write separate lines each with their own ANSI color code to make sure all text is yellow.
